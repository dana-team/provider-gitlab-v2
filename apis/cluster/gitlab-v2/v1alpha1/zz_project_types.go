...
type ProjectInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/dana-team/provider-gitlab-v2/apis/cluster/gitlab-v2/v1alpha1.Group
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	NamespaceID *float64 `json:"namespaceId,omitempty" tf:"namespace_id,omitempty"`

	// Reference to a Group in gitlab-v2 to populate namespaceId.
	// +kubebuilder:validation:Optional
	NamespaceIDRef *v1.Reference `json:"namespaceIdRef,omitempty" tf:"-"`

	// Selector for a Group in gitlab-v2 to populate namespaceId.
	// +kubebuilder:validation:Optional
