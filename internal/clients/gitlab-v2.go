...
import (
	...
	clusterv1beta1 "github.com/dana-team/provider-gitlab-v2/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/dana-team/provider-gitlab-v2/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal gitlab-v2 credentials as JSON"
)
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		if pcSpec.BaseURL != nil && *pcSpec.BaseURL != "" {
			ps.Configuration["base_url"] = *pcSpec.BaseURL
		}
		if pcSpec.Insecure != nil && *pcSpec.Insecure {
